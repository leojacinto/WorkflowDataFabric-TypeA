...
<mark style="color:$warning;">**\[Internal Only]**</mark> There are steps in this lab which look different compared to the internal Demo Hub instances accessible internally to ServiceNow Solution Consultants. A summary of these differences are can be accessed in [Demo Hub for Solution Consultants](https://servicenow-lf.gitbook.io/the-workflow-data-fabric-loom/demo-hub-for-scs/demo-hub-for-solution-consultants).&#x20;
